...
{
	/// <summary>
	/// Generic overload of Equals to avoid boxing. Makes use of function pointers for best performance and does not throw on null for reference types.
	/// </summary>
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static unsafe bool Equals<T>([AllowNull] this ref T @this, [AllowNull] ref T other)
